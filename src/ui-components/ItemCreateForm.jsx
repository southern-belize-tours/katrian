...
export default function ItemCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setItemImageUrl(initialValues.itemImageUrl);
    setItemPrice(initialValues.itemPrice);
    setItemQuantity(initialValues.itemQuantity);
    setItemLink(initialValues.itemLink);
    setItemStatus(initialValues.itemStatus);
    setGuestName(initialValues.guestName);
    setGuestMessage(initialValues.guestMessage);
    setItemTimestam(initialValues.itemTimestam);
    setErrors({});
  };
  const validations = {
