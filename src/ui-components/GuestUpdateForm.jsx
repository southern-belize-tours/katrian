...
export default function GuestUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = guestRecord
      ? { ...initialValues, ...guestRecord }
      : initialValues;
    setFirst(cleanValues.first);
    setLast(cleanValues.last);
    setAttending_ceremony(cleanValues.attending_ceremony);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getGuest.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getGuest
        : guestModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          first: first ?? null,
          last: last ?? null,
          attending_ceremony: attending_ceremony ?? null,
        ...
        try {
          ...
          await client.graphql({
            query: updateGuest.replaceAll("__typename", ""),
            variables: {
              input: {
                id: guestRecord.id,
                ...modelFields,
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || guestModelProp)}
