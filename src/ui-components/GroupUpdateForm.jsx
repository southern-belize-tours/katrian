...
export default function GroupUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setInvited_rehearsal(cleanValues.invited_rehearsal);
    setAddress(cleanValues.address);
    setCity(cleanValues.city);
    setState(cleanValues.state);
    setEmail(cleanValues.email);
    setGuest_ids(cleanValues.Guest_ids ?? []);
    setCurrentGuest_idsValue("");
    setZip(cleanValues.zip);
    setInvited_happy_hour(cleanValues.invited_happy_hour);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          title: title ?? null,
          invited_rehearsal: invited_rehearsal ?? null,
          address: address ?? null,
          city: city ?? null,
          state: state ?? null,
          email: email ?? null,
          Guest_ids: Guest_ids ?? null,
          zip: zip ?? null,
          invited_happy_hour: invited_happy_hour ?? null,
          phone: phone ?? null,
        };
